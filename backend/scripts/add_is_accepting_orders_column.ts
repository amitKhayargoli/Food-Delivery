/**
 * Migration: Add is_accepting_orders column to restaurant_applications
 *
 * Run this via the Supabase SQL editor or execute locally:
 *   npx ts-node backend/scripts/add_is_accepting_orders_column.ts
 */
...
async function main() {
  ...
  console.log('\nAll connections failed. Please run the SQL manually via Supabase SQL editor:');
